...
class DSMCSimulation:
    ...
    def initialize_logger(self):
        ...
        self.folder_name = f"dsmc_{model_type}_N-{self.n_particles}_steps-{self.n_steps}_Ttr-{self.T_tr_initial}_Trot-{self.T_rot_initial}_Zr-{self.Z_r}_domain-{self.domain_size}_cells{self.n_cells}_sigma{self.sigma_collision}"
        self.folder_name = os.path.join(LOG_DIR, self.folder_name)
